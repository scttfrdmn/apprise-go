...
func TestVersion(t *testing.T) {
	version := GetVersion()
	if version != "1.9.5-2" {
		t.Errorf("Expected version 1.9.5-2, got %s", version)
	}
}
...
func TestVersionInfo(t *testing.T) {
	...
	if info.Version != "1.9.5-2" {
		t.Errorf("Expected version 1.9.5-2, got %s", info.Version)
	}
...
func TestGetUserAgent(t *testing.T) {
	...
	if !strings.Contains(userAgent, "Apprise-Go/1.9.5-2") {
		t.Errorf("User agent should contain Apprise-Go/1.9.5-2, got %s", userAgent)
	}
...
func TestVersionInfoString(t *testing.T) {
	...
	if !strings.Contains(versionString, "Apprise-Go 1.9.5-2") {
		t.Errorf("Version string should contain Apprise-Go 1.9.5-2, got %s", versionString)
	}
...
func TestVersionConstants(t *testing.T) {
	...
	if Version != "1.9.5-2" {
		t.Errorf("Version constant should be 1.9.5-2, got %s", Version)
	}
